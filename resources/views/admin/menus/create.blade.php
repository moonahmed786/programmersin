...
<div class="mb-8">
    <div class="flex items-center gap-4 mb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Add Menu Item</h1>
            <p class="text-sm text-slate-500 mt-0.5">Create a new navigation link</p>
        </div>
    </div>
</div>
                                ...
                                <div class="relative">
                                    <select id="parent_id" name="parent_id" 
                                        ...
                                        @foreach($parentMenus as $parent)
                                            <option value="{{ $parent->id }}">{{ $parent->title }} ({{ ucfirst($parent->location) }})</option>
                                        @endforeach
                                    </select>
                                    <span class="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-slate-300 pointer-events-none text-lg">unfold_more</span>
                                </div>
