...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    <div class="col-span-1 md:col-span-2 bg-surface-container-lowest p-10 rounded flex flex-col justify-center relative overflow-hidden group border border-outline-variant/10 shadow-xl shadow-slate-200/40">
    ...
    <div class="bg-primary p-8 rounded flex flex-col justify-between shadow-2xl shadow-primary/20 group overflow-hidden relative">
    ...
    <div class="bg-surface-container-lowest p-8 rounded flex flex-col justify-between border border-outline-variant/10 shadow-xl shadow-slate-200/40">
...
<!-- Table Section -->
<div class="bg-surface-container-lowest rounded overflow-hidden shadow-2xl shadow-slate-200/50 border border-outline-variant/10">
    <!-- Table Controls -->
    <div class="px-10 py-8 flex flex-wrap items-center justify-between gap-6 border-b border-outline-variant/10">
        <div class="flex items-center gap-8">
            ...
            <div class="flex items-center gap-2 bg-surface-container-low p-1.5 rounded border border-outline-variant/5">
                <button class="px-6 py-2 text-[10px] font-black uppercase tracking-widest rounded bg-on-surface text-surface shadow-lg">All Units</button>
                <button class="px-6 py-2 text-[10px] font-black uppercase tracking-widest rounded text-on-surface-variant hover:text-primary transition-all">Client Side</button>
                <button class="px-6 py-2 text-[10px] font-black uppercase tracking-widest rounded text-on-surface-variant hover:text-primary transition-all">Core Ops</button>
            </div>
        </div>
        <div class="flex items-center gap-6">
            <button class="bg-primary text-on-primary px-8 py-4 rounded text-[10px] font-black uppercase tracking-widest flex items-center gap-3 hover:opacity-90 shadow-2xl shadow-primary/30 transition-all hover:-translate-y-1">
        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y-0">
                ...
                <tr class="group hover:bg-surface-container/30 transition-all">
                    <td class="px-10 py-8">
                        <div class="flex items-center gap-5">
                            <div class="w-14 h-14 rounded bg-blue-50 flex items-center justify-center text-blue-600 shadow-sm border border-blue-100/50">
                    ...
                    <td class="px-8 py-8">
                        <span class="px-4 py-1.5 bg-surface-container-low text-on-surface-variant text-[10px] font-black rounded uppercase tracking-widest border border-outline-variant/10">Mobile Apps</span>
                    </td>
                    <td class="px-8 py-8">
                    ...
                    <td class="px-8 py-8 text-right">
                        <span class="inline-flex items-center gap-2 px-3 py-1 bg-surface-container rounded text-[10px] font-black uppercase tracking-widest text-on-surface-variant border border-outline-variant/10">
                            <span class="w-1.5 h-1.5 rounded bg-secondary/100 shadow-[0_0_8px_rgba(16,185,129,0.5)]"></span>
                            Production
                        </span>
                    </td>
                    <td class="px-10 py-8 text-right">
                        <button class="w-10 h-10 hover:bg-surface-container rounded text-slate-300 hover:text-primary transition-all flex items-center justify-center group/btn border border-transparent hover:border-outline-variant/20">
                ...
                <tr class="group hover:bg-surface-container/30 transition-all">
                    <td class="px-10 py-8">
                        <div class="flex items-center gap-5">
                            <div class="w-14 h-14 rounded bg-indigo-50 flex items-center justify-center text-indigo-600 shadow-sm border border-indigo-100/50">
                    ...
                    <td class="px-8 py-8">
                        <span class="px-4 py-1.5 bg-surface-container-low text-on-surface-variant text-[10px] font-black rounded uppercase tracking-widest border border-outline-variant/10">Cloud Infra</span>
                    </td>
                    <td class="px-8 py-8">
                        <div class="flex items-center gap-3">
                            <span class="material-symbols-outlined text-sm text-slate-300">timer</span>
                    ...
                    <td class="px-8 py-8 text-right">
                        <span class="inline-flex items-center gap-2 px-3 py-1 bg-surface-container rounded text-[10px] font-black uppercase tracking-widest text-on-surface-variant border border-outline-variant/10">
                            <span class="w-1.5 h-1.5 rounded bg-slate-300"></span>
                            Standby
                        </span>
                    </td>
                    <td class="px-10 py-8 text-right">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 mb-10">
    <div class="bg-surface-container-lowest p-10 rounded border border-outline-variant/10 shadow-2xl shadow-slate-200/40">
        ...
        <div class="space-y-6">
            <div class="space-y-3">
                ...
                <div class="w-full h-1.5 bg-surface-container-low rounded overflow-hidden shadow-inner">
                    <div class="h-full bg-primary w-[62%] rounded shadow-[0_0_8px_rgba(0,86,210,0.3)]"></div>
                </div>
            </div>
            <div class="space-y-3">
                <div class="flex items-center justify-between">
                ...
                <div class="w-full h-1.5 bg-surface-container-low rounded overflow-hidden shadow-inner">
                    <div class="h-full bg-indigo-600 w-[45%] rounded shadow-[0_0_8px_rgba(79,70,229,0.3)]"></div>
                </div>
            </div>
        </div>
    </div>
    <div class="bg-surface-container-lowest p-10 rounded border border-outline-variant/10 shadow-2xl shadow-slate-200/40">
        ...
        <div class="space-y-5">
            <div class="flex gap-4">
                <div class="w-2 h-2 rounded bg-primary mt-1.5 shadow-[0_0_8px_rgba(0,86,210,0.4)]"></div>
            ...
            <div class="flex gap-4">
                <div class="w-2 h-2 rounded bg-secondary/100 mt-1.5 shadow-[0_0_8px_rgba(16,185,129,0.4)]"></div>
    ...
    <div class="bg-gradient-to-br from-on-surface to-slate-800 p-10 rounded text-surface shadow-2xl shadow-on-surface/30 flex flex-col justify-between group overflow-hidden relative">
        <div class="relative z-10">
        ...
        <button class="w-full mt-6 py-4 bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-widest rounded hover:bg-white/10 transition-all">View Audit Report</button>
