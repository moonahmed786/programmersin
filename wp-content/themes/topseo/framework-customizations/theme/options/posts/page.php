...
$options = array(
    'page_option' => array(
        ...
        'options' => array(
            ...
            'page_menu_style' => array(
                'type'    => 'short-select',
                'label'   => esc_html__( 'Menu background', 'topseo' ),
                'choices' => array(
                    'default'      => esc_html__( 'Default', 'topseo' ),
            ...
            'page_menu_sticky' => array(
                'type'    => 'short-select',
                'label'   => esc_html__( 'Menu layout', 'topseo' ),
                'choices' => array(
                    'default'      => esc_html__( 'Default', 'topseo' ),
                    'default-menu' => esc_html__( 'Normal', 'topseo' ),
                    'sticky-menu'  => esc_html__( 'Stick', 'topseo' ),
                ),
                'value' => 'default'
            ),
        )
