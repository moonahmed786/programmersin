 ...
 */
$audio = (function_exists('fw_get_db_post_option') ? fw_get_db_post_option($post->ID, 'audio') : '');
?>
<div itemscope itemtype="https://schema.org/Blog">
	<article id="post-<?php the_ID(); ?>" class="blog-post post-type-audio hentry" itemid="<?php echo get_permalink(); ?>" itemscope itemtype="http://schema.org/BlogPosting">
		<div class="flw" itemprop="mainEntityOfPage">
			<?php
				if($audio != ''):
					echo '<div class="blog-post-cover use-plyr-render">'.
					htmlspecialchars_decode(esc_html($audio));
			...
			<div class="blog-post-info entry-content">
				...
				<div class="blog-post-sumary">
					...
					<?php if(!is_single()) : ?>
						<div class="blog-btn-read-more"><a href="<?php the_permalink(); ?>" class="ion-ios-list-outline"><?php esc_html_e('READ MORE', 'topseo'); ?></a></div>
					<?php endif; ?>
				</div>
			</div>
		</div>
