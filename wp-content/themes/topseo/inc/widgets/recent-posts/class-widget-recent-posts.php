...
class Topseo_Widget_Recent_Posts extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct( false, esc_html__( 'Recent Posts Thumbnail', 'topseo'), $widget_ops );
    }
    ...
    function form( $instance ) {
        $instance = wp_parse_args( (array) $instance, array( 'number' => 5, 'title' => esc_html__('Recent Posts', 'topseo' ) ) );
        ?>
        <p>
