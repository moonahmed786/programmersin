<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php
		$content = apply_filters( 'markethon_the_content', get_the_content() );
		$audio = false;
	...
	<div class="iq-page-blog">
		<div class="iq-blog-box">	
			...
			if(isset($markethon_option['markethon_display_image']))
			{
			$options = $markethon_option['markethon_display_image'];
			if($options == "yes"){
				...
				<?php 
					...
					wp_link_pages( array(
						'before'      => '<div class="page-links">' . esc_html__( 'Pages:', 'markethon' ),
						'after'       => '</div>',
	...
	<?php 
	$markethon_option = get_option('markethon_options');
	if(isset($markethon_option['markethon_display_comment']))
		{
		$options = $markethon_option['markethon_display_comment'];
		if($options == "yes")
		{
			if(is_single()){
