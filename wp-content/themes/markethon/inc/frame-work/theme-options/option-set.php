<?php
    ...
    $args = array(
        ...
        'menu_title'           => esc_html__( 'markethon Options','markethon'),
        'page_title'           => esc_html__( 'markethon Options','markethon'),
