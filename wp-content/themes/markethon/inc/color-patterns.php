 ...
 */
function markethon_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter markethon default saturation level.
	 *
	 * @since markethon 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'markethon_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.markethon-front-page) .entry-title,
...
.colors-custom .markethon-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.markethon-front-page .panel-content .recent-posts article,
...
.colors-custom.markethon-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters markethon custom colors CSS.
	 *
	 * @since markethon 1.0
	 *
	 ...
	 */
	return apply_filters( 'markethon_custom_colors_css', $css, $hue, $saturation );
}
?>